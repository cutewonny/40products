...
for i in range(len(name_list)):
    ...
    doc.save('/Users/devwonny/Documents/40products/12. 엑셀의 정보를 불러와 수료증 자동 생성/'+name_list[i]+'.docx')
    convert('/Users/devwonny/Documents/40products/12. 엑셀의 정보를 불러와 수료증 자동 생성/'+name_list[i]+'.docx',
            '/Users/devwonny/Documents/40products/12. 엑셀의 정보를 불러와 수료증 자동 생성/'+name_list[i]+'.pdf')